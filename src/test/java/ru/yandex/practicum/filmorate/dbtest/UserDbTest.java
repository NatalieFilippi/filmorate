...
public class UserDbTest {
    ...
    public void testAddFriend() {
        ...
        assertEquals(userStorage.getFriends(user.getId()).get(0).getId(),friend.getId());
    }
    ...
    public void testGetCommonFriends() {
        ...
        User friend = users.get(1);
        userStorage.addFriend(user.getId(), friend.getId());
        assertEquals(userStorage.getCommonFriends(user.getId(), friend.getId()).size(),0);
        ...
        assertEquals(userStorage.getCommonFriends(user.getId(), friend.getId()).size(),1);
    }
