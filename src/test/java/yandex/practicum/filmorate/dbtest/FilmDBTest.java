...
public class FilmDBTest {
    ...
    public void testFindFilmById() throws ObjectNotFoundException {
        ...
        Optional<Film> filmOptional = Optional.ofNullable(filmStorage.findFilmById(id));
    ...
    public void testFindFilmByIdUnknown() {
        ObjectNotFoundException ex = assertThrows(ObjectNotFoundException.class, ()->filmStorage.findFilmById(-1));
    ...
    public void testUpdateFilm() throws ObjectNotFoundException {
        ...
        Optional<Film> filmOptional = Optional.ofNullable(filmStorage.findFilmById(film.getId()));
    ...
    public void testDeleteFilm() throws ObjectNotFoundException {
        ...
        assertEquals(filmStorage.findAllFilms().size(), 0);
    }

    @Test
    public void testDeleteFilmUnknown() {
        ObjectNotFoundException ex = assertThrows(ObjectNotFoundException.class, ()->filmStorage.deleteFilm(-1));
        assertEquals(ex.getMessage(), "Фильм не найден.");
    }

    @Test
    public void testAddLike() {
        Film film = filmStorage.findAllFilms().get(0);
    ...
    public void testGetPopularFilms() {
        List<Film> films = filmStorage.findNMostPopularFilms(Optional.of(1));
        assertEquals(films.size(), 1);
    }
    ...
    public void testFindMPAByIdUnknown() {
        ObjectNotFoundException ex = assertThrows(ObjectNotFoundException.class, ()->mpaStorage.findMpaById(-1));
        assertEquals(ex.getMessage(), "Неизвестный рейтинг");
    }

    @Test
    public void testFindAllMpa() {
        assertEquals(mpaStorage.findAllMpa().size(), 5);
    }

    //Жанры
    @Test
    public void testFindGenreById() throws ObjectNotFoundException {
        Optional<Genre> genreOptional = Optional.ofNullable(genreStorage.findGenre(1));
    ...
    public void testFindGenreByIdUnknown() {
        ObjectNotFoundException ex = assertThrows(ObjectNotFoundException.class, ()->genreStorage.findGenre(-1));
        assertEquals(ex.getMessage(), "Неизвестный жанр");
    }

    @Test
    public void testFindAllGenres() {
        assertEquals(genreStorage.findAllGenres().size(), 6);
    }
